...
const changeCurrentPassword= asyncHandler(async(req,res)=>{
    ...
    const user= await User.findById(req.user?._id) //agar user password change kr paa rha  hai mtlb vo already logged in hai , or if logged in then jo middleware bnaya tha usme req.user = user tha ,  jisse hm user ko identify krenge
